...
const Homepage = () => {
  ...
  return (
    <div className="container mt-5">
      ...
      <form action="">
        <input onChange={(e) => setSearchQuery(e.target.value)} type="text" className="form-control mb-3" placeholder="Search course by name"/>
      ...
      >
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img
              src="https://images.pexels.com/photos/4497761/pexels-photo-4497761.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
              class="d-block w-100"
              alt="Sunset Over the City"
            />
            <div class="carousel-caption d-none d-md-block">
              <h5>Welcome to Educapedia</h5>
      ...
      <div>
        <h1 className="mt-5 mb-4">Available course</h1>
                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
                      <div className="d-flex justify-content-between">
                        <h5 class="card-title text-black">{product.name.slice(0, 14)}</h5>
